...
% 
[assetCl,assetCategorie,cur_weight,lowerBound,upperBound,lowerBsubPort,upperBsubPort,turnOver] = getCurPortfolio();
noAssets = size(assetCl,1);

% get current views / scenarios
[~,viewNames,viewReturns,viewProb,viewStDev] = getCurViews();

% get current VCM
[~,corr_curr,stdev_curr] = getCor();
